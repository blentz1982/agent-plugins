...
If the list is empty or the customer wants to register a new source, run `atx ct source add` via the [continuous-modernization-source](continuous-modernization-source.md) skill, then return here.
